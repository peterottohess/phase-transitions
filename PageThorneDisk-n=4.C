...
// ***********************************************
  ...
  double f=(6*pow(a,3)*pow(r,2)*sqrt(3/(-B+3*pow(r,3)))*(2*B-3*pow(r,3))+a*sqrt(3/(-B+3*pow(r,3)))*(-2*pow(B,2)+3*B*(3-4*r)*pow(r,3)+18*pow(r,6)*(-2+3*r))-(3*pow(r,3)*(-2*pow(B,2)+6*(-6+r)*pow(r,6)+B*pow(r,3)*(9+4*r)))/(B-3*pow(r,3))+2*pow(a,2)*r*(-8*B+3*pow(r,3)*(8-6*r-9*pow(r,4)/(B-3*pow(r,3)))))
/(2*(a+sqrt(3*pow(r,6)/(-B+3*pow(r,3))))*(3*B*pow(r,2)+6*(-3+r)*pow(r,5)-4*a*B*sqrt(3*pow(r,6)/(-B+3*pow(r,3)))+12*a*pow(r,3)*sqrt(3*pow(r,6)/(-B+3*pow(r,3)))))
;
  return f;
}
...
/*  double ff=
  ...
  */
  ...
  double B= myPars[1];
  double r=x2;
  double prefactor =(3*sqrt(3/(-B+3*pow(r,3)))*(2*B-3*pow(r,3)))/(3*B+6*(-3+r)*pow(r,3)-4*aa_*B*r*sqrt(3/(-B+3*pow(r,3)))+12*aa_*pow(r,4)*sqrt(3/(-B+3*pow(r,3))));
